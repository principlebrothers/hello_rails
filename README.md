...
```sh
  cd my-folder
  git clone https://github.com/principlebrothers/hello_rails.git
```
...
Feel free to check the [issues page](https://github.com/principlebrothers/hello_rails/issues/new).
